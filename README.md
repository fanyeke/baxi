...
- 规则驱动决策引擎含沙盘模拟
- Python FastAPI 网关已退役，统一由 Go chi API 提供服务
...
```
baxi/
├── cmd/              # Go 入口点（baxi-api, baxi-cli, baxi-worker）
├── internal/         # Go 核心：23 个包
│   ├── api/          # chi HTTP 服务（9 个 handler、4 个中间件）
