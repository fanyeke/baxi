...
- 飞书集成（消息推送、多维表格同步）
- MCP Server（17 个工具，8 个业务域）/ Pi Agent 集成

## 技术栈

| 层 | 技术 | 说明 |
|----|------|------|
| **后端** | Go 1.22+ (chi, pgx) | API 服务、Worker、CLI |
...
| **MCP Server** | Go (mark3labs/mcp-go) | 17 个工具，Pi Agent 集成 |
...
├── internal/         # Go 核心：41 个包
│   ├── api/          # chi HTTP 服务（14 个 handler、6 个中间件）
