// Package status provides repository access for system status aggregation.
...
func (r *Repository) GetTableCounts(ctx context.Context) ([]TableCount, error) {
	query := `
...
func (r *Repository) GetLastPipelineRun(ctx context.Context) (*PipelineRunRow, error) {
	query := `
