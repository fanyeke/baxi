// Package outbox provides repository access for the outbox domain.
...
// Repository provides read-only access to ops.outbox_event.
...
func (r *Repository) GetDetail(ctx context.Context, eventID string) (*OutboxDetail, error) {
	var d OutboxDetail
	err := r.QueryRow(ctx, `
...
func (r *Repository) ListOutboxEvents(
	ctx context.Context,
